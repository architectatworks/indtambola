...
class TambolaGameManager extends Component {
    ...
    setDefaultGameNumbers = () => {
        const numbers = {};
        let valuetobedisplay =0;
        let allowedtoedit=true;
        for (let currentNumber = 1; currentNumber <= this.state.maxNumbers; currentNumber += 1) {
            if (currentNumber % 2 === 0) valuetobedisplay = -1; else valuetobedisplay =currentNumber
            // if (currentNumber % 3 === 0) allowedtoedit = true; else allowedtoedit = false
            numbers[currentNumber] = ({
                value: valuetobedisplay,
    ...
    render() {
        return (
            <div className='TambolaGameManager'>
                ...
                <h5 className='Footer'>
                    Note: This is for the internal purpose only.
                </h5>
            </div>
        );
    }
